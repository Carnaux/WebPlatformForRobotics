...
PCF8591 pcf8591(PCF8591_I2C_ADDRESS, 2, 4);
...
// WIFI
//const char* SSID = "Residencial 186 2.4 GHz"; // SSID
    ...
    MQTT.loop();
     ...
     if(checkRun){
       if(ReadEncoders(1)){
          ...
          int analog1 = pcf8591.analogRead(AIN0);
          float piezoV1 = analog1 / 1023.0 * 5.0;
          sprintf(Voltage,"M1V%d",piezoV1);
          MQTT.publish(TOPICO_PUBLISH, Voltage);
